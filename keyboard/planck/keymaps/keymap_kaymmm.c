...
#include <util/delay.h> // couldn't get it to compile w/o it. not sure if this include belongs elsewhere...
...
/* MISC_LAYER/FN4: more arrows (until I figure out what to do with this layer)
 *  ,-----------------------------------------------------------------------------------------------.
 *  |       |       |  Up   |       |       |       |       |       |       |       |       |       |
 *  |-----------------------------------------------------------------------------------------------|
